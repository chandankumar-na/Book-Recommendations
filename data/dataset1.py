...
def filter_data():
    ...
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('dislike',0, regex=True)
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('view',1,  regex=True)
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('like',2,  regex=True)
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('add to cart',3,  regex=True)
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('interact',4,  regex=True)
    us_canada_user_impression.impression=us_canada_user_impression.impression.replace('checkout',5,  regex=True)
    ...
    us_canada_user_impression_pivot = us_canada_user_impression.pivot(index = 'bookName', columns = 'user_id', values = 'impression').fillna(0)
